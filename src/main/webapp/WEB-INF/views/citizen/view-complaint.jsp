...
<%
    ...
    boolean hasVoted = (request.getAttribute("hasVoted") != null) ? (boolean) request.getAttribute("hasVoted") : false;
%>
                <!DOCTYPE html>
                <html lang="en">
                        ...
                        function toggleVote(complaintId, btnElement) {
                            ...
                            fetch('<%= request.getContextPath() %>/citizen/vote', {
                                ...
                                .then(status => {
                                    ...
                                    const textElement = document.getElementById('vote-btn-text');
                                    let currentCount = parseInt(countElement.innerText);

                                    if (status === 'voted') {
                                        btnElement.classList.add('voted');
                                        countElement.innerText = currentCount + 1;
                                        if (textElement) textElement.innerText = 'Remove Support';
                                    } else if (status === 'unvoted') {
                                        btnElement.classList.remove('voted');
                                        countElement.innerText = currentCount - 1;
                                        if (textElement) textElement.innerText = 'Support This Issue';
                                    }
                                })
                    ...
                    <main class="citizen-dashboard">
                        ...
                        <nav class="breadcrumb" style="margin-bottom: 1.5rem; font-size: 0.85rem; color: #64748b;">
                            ...
                            <% if (complaint.getUserId()==userId) { %>
                                <a href="<%= request.getContextPath() %>/citizen/my-complaints"
                                    style="color: #3b82f6; text-decoration: none;">My Complaints</a>
                                <span style="margin: 0 0.5rem;">›</span>
                                <% } %>
                        ...
                        <div class="complaint-detail-grid">
                                ...
                                <div class="content-card" style="padding: 2rem;">
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <h1
                                                style="font-size: 1.75rem; color: #1e293b; font-weight: 700; margin-top: 0.5rem;">
                                                <%= complaint.getTitle() %>
                                            </h1>
                                            <p style="color: #64748b; margin-top: 0.25rem;">Submitted on <%=
                                                    complaint.getCreatedAt().format(formatter) %>
                                            </p>
                                        </div>
                                        <div style="text-align: right;">
                                            <div style="font-size: 1.5rem; font-weight: 700; color: #2563eb;"
                                                id="vote-count-<%= complaint.getId() %>">
                                                <%= complaint.getVoteCount() %>
                                            </div>
                                            <div style="font-size: 0.7rem; color: #94a3b8; font-weight: 600;">SUPPORTS
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="evidence-container">
                                        <% if (complaint.getImagePath() !=null && !complaint.getImagePath().isEmpty()) {
                                            %>
                                            <img src="<%= request.getContextPath() %>/<%= complaint.getImagePath() %>"
                                                alt="Evidence" class="evidence-image">
                                            <% } else { %>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-value"
                                            style="background: #f8fafc; padding: 1.5rem; border-radius: 8px; border-left: 4px solid #e2e8f0;">
                            ...
                            <div class="right-section">
                                <div class="content-card" style="padding: 2rem; margin-bottom: 1.5rem;">
                                    <h3
                                        style="font-size: 1.1rem; color: #1e293b; margin-bottom: 1.5rem; border-bottom: 1px solid #f1f5f9; padding-bottom: 0.75rem;">
                                        Location & Category</h3>

                                    <div class="detail-item">
                                        <div class="detail-label">Municipality</div>
                                        <div class="detail-value">
                                            <%= session.getAttribute("municipalityName") %>
                                        </div>
                                    </div>

                                    <div class="detail-item">
                                        <div class="detail-label">Ward Number</div>
                                        <div class="detail-value">Ward No. <%= complaint.getWardNumber() %>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-value">
                                            <span class="admin-badge"><%= complaint.getCategoryName() != null ? complaint.getCategoryName().toUpperCase() : "N/A" %></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content-card" style="padding: 2rem; margin-bottom: 1.5rem;">
                                    <h3
                                        style="font-size: 1.1rem; color: #1e293b; margin-bottom: 1.5rem; border-bottom: 1px solid #f1f5f9; padding-bottom: 0.75rem;">
                                        Reporter Information</h3>

                                    <div class="detail-item">
                                        <div class="detail-label">Submitted By</div>
                                        <div class="detail-value">
                                            <% if (complaint.isAnonymous()) { %>
                                                <i class="fas fa-user-secret" style="margin-right: 5px;"></i> Anonymous
                                                Citizen
                                                <% } else { %>
                                                    <i class="fas fa-user" style="margin-right: 5px;"></i>
                                                    <%= complaint.getUserName() !=null ? complaint.getUserName()
                                                        : "Citizen" %>
                                                        <% } %>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-value">
                                            <%= (complaint.getContactEmail() !=null &&
                                                !complaint.getContactEmail().isEmpty()) ? complaint.getContactEmail()
                                                : "Not provided" %>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Action Button -->
                                <% if (complaint.getUserId()==userId && "pending"
                                    .equalsIgnoreCase(complaint.getStatus())) { %>
                                    <a href="<%= request.getContextPath() %>/citizen/edit-complaint?id=<%= complaint.getId() %>"
                                        class="btn-primary"
                                        style="width: 100%; padding: 1rem; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 10px;">
                                        <i class="fas fa-edit"></i> Edit This Complaint
                                    </a>
                                    <% } else { %>
                                        <button class="btn-primary <%= hasVoted ? " voted" : "" %>" onclick="toggleVote(
                                            <%= complaint.getId() %>, this)" style="width: 100%; padding: 1rem; display:
                                                flex; align-items: center; justify-content: center; gap: 10px;">
                                                <i class="fas fa-thumbs-up"></i> <span id="vote-btn-text">
                                                    <%= hasVoted ? "Remove Support" : "Support This Issue" %>
                                                </span>
                                        </button>
                                        <% } %>
                            </div>
